...
GITHUB_REPO = "apartmentxjp-commits/akiya_seo"
HUGO_POST_PATH = "site/content/post"
GIT_USER_NAME = os.getenv("GIT_USER_NAME", "Akiya Bot")
GIT_USER_EMAIL = os.getenv("GIT_USER_EMAIL", "bot@akiya.local")
...
def _github_api_push_file(filename: str, content: str, commit_msg: str) -> bool:
    ...
    headers = {
        ...
        "User-Agent": "Akiya-Publisher/1.0",
    }
