  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold">🏠 空き家SEO — AIエージェント管理</h1>
          <p className="text-muted text-sm mt-1">Groq (Llama 3.3 70b) による空き家・古民家記事自動生成</p>
        </div>
        <button
          onClick={fetchStatus}
